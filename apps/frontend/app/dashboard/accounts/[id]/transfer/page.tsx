    ...
    return (
      <div className={styles.page}>
        ...
        <div className={styles.successCard}>
          ...
          <p className={styles.successSub}>Your transfer has been completed.</p>
          <div className={styles.successMeta}>
            ...
            <div className={styles.metaRow}>
              <span className={styles.metaLabel}>Amount transferred</span>
    ...
    return (
      <div className={styles.page}>
        ...
        <div className={styles.confirmCard}>
          ...
          <p className={styles.confirmSub}>Please review the details carefully before confirming.</p>
  ...
  return (
    <div className={styles.page}>
      ...
      {account && (
        <div className={styles.accountSummary}>
          <div className={styles.summaryItem}>
            <p className={styles.summaryLabel}>From account</p>
      ...
      <div className={styles.formCard}>
        ...
        <p className={styles.formSub}>Send money to another Cowry account.</p>
        ...
        <form onSubmit={handleReview} className={styles.form}>
          ...
          <div className={styles.field}>
            ...
            {account && (
              <p className={styles.fieldHint}>Max: {fmt(account.balance, account.currency)}</p>
            )}
          </div>
